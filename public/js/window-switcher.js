...
function windowSwitcher(targetWindow, options) {
  ...
  switch (targetWindow) {
    ...
    case 'double_check':
      windowShow();
      var deleteVariableWindow = document.createElement('div');
